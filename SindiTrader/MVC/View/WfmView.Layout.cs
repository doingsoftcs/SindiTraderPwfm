...
namespace SindiTrader
{
    public partial class WfmView : Form, IView, IModelToView
    {
        ...
        protected ComboBox _cbx = new ComboBox();
        ...
        protected void _InitFlp()
        {
            ...
            _cbx.Name = "cbx조회";
            _cbx.KeyDown += _OnCbxKeyDown;
            _cbx.KeyPress += _OnCbxKeyPress;
            _cbx.AutoCompleteMode = AutoCompleteMode.SuggestAppend;
            _cbx.AutoCompleteSource = AutoCompleteSource.ListItems;

            //
            this._flp.Controls.Add(_cbx);
        }
        ...
        //
        protected void _UpdateCtrl(string 단축코드, 현물차트 p, string 현물마스터)
        {
            ...
            //
            if (string.IsNullOrEmpty(단축코드) || null == p || string.IsNullOrEmpty(현물마스터))
                return;
